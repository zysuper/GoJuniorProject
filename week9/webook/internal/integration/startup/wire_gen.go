...
var likeTopProvider = wire.NewSet(dao.NewGORMLikeTopNDAO, cache.NewRedisLikeTopCache, repository.NewCachedTopNServiceRepository, service.NewDefaultTopNService, web.NewLikeTopHandler)
