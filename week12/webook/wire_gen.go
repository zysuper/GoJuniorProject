...
func InitWebServer() *App {
	...
	intrRepository := repository.NewIntrRepository(interactiveServiceClient)
	articleCache := cache.NewArticleRedisCache(cmdable)
	articleRepository := repository.NewCachedArticleRepository(articleDAO, userRepository, intrRepository, articleCache)
